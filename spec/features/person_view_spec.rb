...
describe 'the person view', type: :feature do
  ...
  describe 'email addresses' do
    before(:each) do
      person.email_addresses.create(address: 'bob@mail.com')
      person.email_addresses.create(address: 'alicesmith@mail.com')
      visit person_path(person)
    end

    it 'shows the email addresses' do
      expect(page).to have_selector('li', text: 'bob@mail.com')
      expect(page).to have_selector('li', text: 'alicesmith@mail.com')
    end
    ...
    it 'adds a new email address' do
      ...
      page.fill_in('Address', with: 'alicesmith@mail.com')
